  ...
  <v-row justify="center">
    <v-dialog v-model="dialog" persistent max-width="900">
      ...
      <v-card>
        <v-card-title>
          <span class="text-h5">
            <v-icon size="small">mdi-folder</v-icon> Project Profile</span
          >
        </v-card-title>
        <v-card-text>
          <v-container>
              ...
              <v-row>
                ...
                >
                  ...
                  <span
                    ...
                    v-if="v$.dataProject.title.$error"
                    >{{ v$.dataProject.title.$errors[0].$message }}</span
                  >
                </v-col>
                ...
                >
                  ...
                  <span
                    class="error-feedback"
                    v-if="v$.dataProject.person.$error"
                  >
                ...
                >
                  ...
                  <span
                    class="error-feedback"
                    v-if="v$.dataProject.status.$error"
                  >
                ...
                >
                  ...
                  <span
                    class="error-feedback"
                    v-if="v$.dataProject.avatar.$error"
                  >
                ...
                >
                  ...
                  <span
                    class="error-feedback"
                    v-if="v$.dataProject.content.$error"
                  >
